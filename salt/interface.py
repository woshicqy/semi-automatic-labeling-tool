...
class ApplicationInterface(QWidget):
    ...
    def get_top_bar(self):
        ...
        buttons = [
            ("Add Object", lambda: self.add()),
            ("Recall Object", lambda: self.delet()),
            ("Reset", lambda: self.reset()),
            ("Prev", lambda: self.prev_image()),
            ("Next", lambda: self.next_image()),
            ("Show annotated Info", lambda: self.toggle()),
            ("Increase transparency", lambda: self.transparency_up()),
            ("Decrease transparency", lambda: self.transparency_down()),
